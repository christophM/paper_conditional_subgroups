# =============================================================================
# Create illustration: Subgroups reduce extrapolation
# =============================================================================
...
pdf(file = sprintf("%s/split-density.pdf", fig_dir), height = 4, width = 8)
print((pplot_marg + pplot_cond) / (p1 + p2) + plot_layout(heights = c(2, 1)))
dev.off()
